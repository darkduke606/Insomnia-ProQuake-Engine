...
void TTY_SetComPortConfig (int portNumber, int port, int irq, int baud, qboolean useModem)
{
	...
	Cvar_SetValueByRef (&_config_com_port, (float)port);
	Cvar_SetValueByRef (&_config_com_irq, (float)irq);
	Cvar_SetValueByRef (&_config_com_baud, (float)baud);
	Cvar_SetValueByRef (&_config_com_modem, temp);
}
...
void TTY_SetModemConfig (int portNumber, char *dialType, char *clear, char *init, char *hangup)
{
	...
	Cvar_SetStringByRef (&_config_modem_dialtype, dialType);
	Cvar_SetStringByRef (&_config_modem_clear, clear);
	Cvar_SetStringByRef (&_config_modem_init, init);
	Cvar_SetStringByRef (&_config_modem_hangup, hangup);
}
